"""Generate C++ killers summary chart (cpp_killers_summary.png).

Horizontal bar chart (log scale) of measured speedups for C++ fixes.
"""
...
ax.set_title("C++ Performance Killers — Measured Speedups",
...
plt.tight_layout()
plt.savefig("cpp_killers_summary.png", dpi=200, bbox_inches="tight",
            transparent=True, edgecolor="none")
print("Saved cpp_killers_summary.png")
